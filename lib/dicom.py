...
def read_dcm(
    paths: List[str], spacing: Tuple[int, int, int] = (1, 1, 1), clip: bool = False
    ...
    Args:
        ...
        spacing (Tuple[int, int, int], optional): X, Y, Z pixel spacing in mm. Defaults to (1, 1, 1).
